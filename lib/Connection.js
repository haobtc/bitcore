...
var MAX_RECEIVE_BUFFER = 50000000;
var DEFAULT_PROTOCOL_VERSION   = 70002;
...
Connection.prototype.getProtocolVersion = function() {
  return this.network.protocolVersion || DEFAULT_PROTOCOL_VERSION;
};
...
Connection.prototype.handleMessage = function(message) {
  ...
  try {
    ...
    case 'version':
      ...
      this.sendVer = Math.min(message.version, this.getProtocolVersion());
      if (message.version < 209) {
        this.recvVer = Math.min(message.version, this.getProtocolVersion());
      } else {
...
Connection.prototype.sendVersion = function () {
  ...
  var put = new Put();
  put.word32le(this.getProtocolVersion()); // version
